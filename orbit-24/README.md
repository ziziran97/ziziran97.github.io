...
The page supports mouse, touch and native keyboard controls, reduced motion, dark/light appearance, loading errors and persisted sound/theme preferences. Animation stops rendering when idle and pauses when the page is hidden.
